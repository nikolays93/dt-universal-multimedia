...
class mediablock_load_post_page
{
    ...
    static function json_options( $post, $default = '' )
    {
        ...
        $form = new Form( Utils::get_settings( '/lib/' . $atts['lib_type'], $atts ), array(
            'is_table' => true,
...
function change_excerpt_box() {
    add_meta_box('mb_excerpt', __('After title content', DOMAIN),
        __NAMESPACE__ . '\excerpt_box', Plugin::get_option_name(), 'normal');
}
